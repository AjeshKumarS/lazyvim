...
-- buffer/editor
vim.keymap.set({ 'n', 'v' }, "<space>bd", editor.closeActive)
vim.keymap.set({ 'n', 'v' }, "<space>bo", editor.closeOther)
...
-- code
vim.keymap.set({ 'n' }, "<leader>cr", code.rename_symbol)
vim.keymap.set({ 'n' }, "<space>cf", code.format)
